      ...
      <Fragment>
        ...
        <Container id='page-container'>
          ...
          <Grid stackable columns={2}>
            <Grid.Column width={8}>
              <Header as='h1' id='checkout-subheader'>Your Details</Header>
              <CustomerDetailsForm
            ...
            <Grid>
            <Grid.Column width={6}>
              <Header as='h1' id='checkout-subheader'>Payment</Header>
              <Elements>
                <PaymentForm formStatus={this.checkPaymentForm} />
              </Elements>
              <Button color='orange' size='large' id='checkout-btn' onClick={this.handleSubmit}>CONFIRM PAYMENT{formatPrice(this.props.checkoutTotal)} </Button>
            </Grid.Column>
          </Grid>
        </Container>
        <Footer />
